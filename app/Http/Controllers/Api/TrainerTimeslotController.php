...
class TrainerTimeslotController extends BaseController
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $timeslots = TrainerTimeslot::orderBy('day_idx', 'asc')
        ...
        return view("trainer-timeslots.list", $timeslots);
    }
    ...
    public function store(Request $request)
    {
        ...
        $timeslot = new TrainerTimeslot($request->all());
        $timeslot->save();
    ...
    {
        //
        $timeslot = TrainerTimeslot::find($id);
        return $timeslot;
    }
