...
class MenuController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $menu = [
            ['label' => 'Dashboard', 'icon' => 'pi pi-fw pi-th-large', 'routerLink' => ['/'], 'visible' => $isSuperUser],
            ...
            ['label' => 'Trainer Student', 'icon' => 'pi pi-fw pi-users', 'routerLink' => ['/trainer-student-list'], 'visible' => $isSuperUser],
